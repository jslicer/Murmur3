...
#pragma warning restore IDE0079 // Remove unnecessary suppression
    ...
    protected override void HashCore(byte[] array, int ibStart, int cbSize)
    {
        ...
        {
            uint k1 = BitConverter.ToUInt32(array, i);
            //// ReSharper disable ComplexConditionExpression
            uint k2 = BitConverter.ToUInt32(array, i + (BlockSizeInBytes / 4));
            uint k3 = BitConverter.ToUInt32(array, i + (BlockSizeInBytes / 2));
            uint k4 = BitConverter.ToUInt32(array, i + (3 * BlockSizeInBytes / 4));
    ...
    protected override byte[] HashFinal()
    {
        ...
        byte[] b3 = BitConverter.GetBytes(this._h3);
        byte[] b4 = BitConverter.GetBytes(this._h4);
